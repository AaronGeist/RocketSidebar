...
public class InvisibleView extends ViewGroup {
	...
	public InvisibleView(Context context) {
		...
		mGestureDetector = new GestureDetector(context, new GestureListner(this));
...
//        } 
//		
//		listItemAdapter = new SimpleAdapter(context, listItem, R.layout.browse_app_item,
//				new String[]{"itemTitle", "itemContent"},  
//				new int[]{R.id.imgApp, R.id.tvLabel});
//		
...
//		this.addView(mListView);
	...
	class GestureListner extends SimpleOnGestureListener {
		...
		public boolean onDown(MotionEvent e) {
			if(e.getX() == 0  & e.getY() > mViewGroup.getY() & e.getY() < (mViewGroup.getY() + mViewGroup.getHeight())) {
...
//				params.width = 500;
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
			if(e1.getX() == 0  & e1.getY() > mViewGroup.getY() & e1.getY() < (mViewGroup.getY() + mViewGroup.getHeight())) {
	...
	public class MyBroadcastReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context arg0, Intent arg1) {
			// TODO Auto-generated method stub
			Toast.makeText(getContext(), "Destory View", Toast.LENGTH_SHORT).show();
